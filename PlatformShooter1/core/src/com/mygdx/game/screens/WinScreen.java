...
public class WinScreen implements Screen {
    ...
    public WinScreen(Game game){
        ...
        gameOverLabel = new Label("You Win", new Label.LabelStyle(font, Color.WHITE));

        font = fontGenerator.generateFont(tryAgainFont);
        tryAgainLabel = new Label("Click Anywhere to Return to Title", new Label.LabelStyle(font, Color.WHITE));
